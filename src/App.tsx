...
function DedicationAndLetterModal({
  ...
  // Try start WITH sound after user tap (mobile browsers may still force mute depending on policy)
  const embedUrl = `https://www.youtube.com/embed/${youtubeVideoId}?autoplay=1&mute=0&playsinline=1&rel=0`;
        ...
        <div className="overflow-hidden rounded-3xl border border-white/20 bg-pink-100/80 shadow-[0_30px_90px_rgba(91,33,64,0.20)] backdrop-blur-2xl">
          ...
          <div className="p-5 md:p-6">
            <div className="grid gap-4 lg:grid-cols-2">
              {/* LETTER FIRST ON PHONE */}
              <div className="order-1 lg:order-2 rounded-2xl border border-white/15 bg-pink-100/70 p-4">
              ...
              {/* VIDEO MOVED TO BOTTOM ON MOBILE */}
              <div className="order-2 lg:order-1 overflow-hidden rounded-2xl border border-white/15 bg-white/60">
                ...
                <div className="p-3 text-[11px] text-[#5b2140]/60">Tap the video if sound doesn’t start automatically 💗</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <GlassCard className="relative overflow-hidden p-6 md:p-10">
              ...
              <div className="relative">
                ...
                <div className="mt-4 max-w-2xl text-sm leading-relaxed text-[#5b2140]/70 md:text-base">
                  Today we spend the day together — soft, intentional, and us-focused.
                </div>
                ...
                {asked ? (
                  <div className="mt-6 rounded-3xl border border-pink-300/25 bg-pink-300/10 p-5">
                    ...
                    <div className="mt-2 text-sm text-[#5b2140]/70">Deal? Today we do it properly.</div>
                  </div>
                ) : null}
              </div>
            </GlassCard>
